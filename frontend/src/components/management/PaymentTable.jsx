...
import DownloadIcon2 from "../../../public/svgs/DownloadIcon2";
...
const data = [
  {
    ...
    about: "Short description about payment",
    status: "Received",
  },
  {
    name: "Subscription Payment",
  ...
  return (
    ...
    >
      <Stack direction="row" spacing={2} alignItems="center">
        <Button sx={{ backgroundColor: "#151B18" }} height="40px">
          <Box display="flex" alignItems="center" gap={2}>
            <span style={{ color: "#9AE1BC" }}>All time</span>
            <Cancel sx={{ color: "#9AE1BC" }} />
          </Box>
        </Button>
        <Button sx={{ backgroundColor: "#151B18" }} height="40px" width="220px">
          <Box display="flex" alignItems="center" gap={2}>
            <span style={{ color: "#9AE1BC" }}>$100,000+ Payments</span>
            <Cancel sx={{ color: "#9AE1BC" }} />
          </Box>
        </Button>
        <Button
